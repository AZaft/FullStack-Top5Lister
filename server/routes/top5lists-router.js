...
router.get('/top5listuser/:user', Top5ListController.getTop5ListsByUser)
router.get('/top5listname/:name', Top5ListController.getTop5ListsByName)
router.get('/top5listcommunity/:name', Top5ListController.getTop5CommunityList)
