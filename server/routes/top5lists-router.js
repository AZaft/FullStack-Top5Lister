...
router.get('/top5listuser/:user', auth.verify, Top5ListController.getTop5ListsByUser)
router.get('/top5listname/:name', auth.verify, Top5ListController.getTop5ListsByName)
